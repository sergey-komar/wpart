<?php
/**
 * Template Name: Интерьеры Levanova
 */
?>
<?php get_header();?>
<main class="main">
    <div class="container-artwork">
      <div class="author-work">
        <h1 class="header__title"><?php the_field('stranicza_interery_levanova_glavnyj_zagolovok');?></h1>
        <div class="author-work__inner">
          <h2 class="author-work__title"><?php the_field('stranicza_interery_levanova_podzagolovok');?></h2>
          <div class="author-work__block">
            <?php
                $art_post = new WP_Query([
                    'post_type' => 'interior-levanova',
                    'post_per_page' => 20
                ])
            ?>
