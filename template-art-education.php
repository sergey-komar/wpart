...
<main class="main">
    <div class="container-artwork">
      <div class="author-work">
        <h1 class="header__title"><?php the_field('otdelnaya_stranicza_iskusstvo_video_glavnyj_zagolovok');?></h1>
        <div class="author-work__inner">
          <h2 class="author-work__title"><?php the_field('otdelnaya_stranicza_iskusstvo_video_podzagolovok');?></h2>
